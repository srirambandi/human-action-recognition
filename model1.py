...
WEIGHTS_PATH = {
    'rgb_kinetics_only' : '/home/prathosh/ram/keras-kinetics-i3d/weights/i3d_inception_rgb_kinetics_only.h5',
    'flow_kinetics_only' : '/home/prathosh/ram/keras-kinetics-i3d/weights/i3d_inception_flow_kinetics_only.h5',
    'rgb_imagenet_and_kinetics' : '/home/prathosh/ram/keras-kinetics-i3d/weights/i3d_inception_rgb_imagenet_and_kinetics.h5',
    'flow_imagenet_and_kinetics' : '/home/prathosh/ram/keras-kinetics-i3d/weights/i3d_inception_flow_imagenet_and_kinetics.h5'
}

# path to pretrained models with no top (no classification layer)
WEIGHTS_PATH_NO_TOP = {
    'rgb_kinetics_only' : '/home/prathosh/ram/keras-kinetics-i3d/weights/i3d_inception_rgb_kinetics_only_no_top.h5',
    'flow_kinetics_only' : '/home/prathosh/ram/keras-kinetics-i3d/weights/i3d_inception_flow_kinetics_only_no_top.h5',
    'rgb_imagenet_and_kinetics' : '/home/prathosh/ram/keras-kinetics-i3d/weights/i3d_inception_rgb_imagenet_and_kinetics_no_top.h5',
    'flow_imagenet_and_kinetics' : '/home/prathosh/ram/keras-kinetics-i3d/weights/i3d_inception_flow_imagenet_and_kinetics_no_top.h5'
}
...
def Inception_Inflated3d(include_top=True,
    ...
    # Mixed 5b
    branch_0 = conv3d_bn(img_input, 256, 1, 1, 1, padding='same', name='Conv3d_5b_0a_1x1')

    branch_1 = conv3d_bn(img_input, 160, 1, 1, 1, padding='same', name='Conv3d_5b_1a_1x1')
    branch_1 = conv3d_bn(branch_1, 320, 3, 3, 3, padding='same', name='Conv3d_5b_1b_3x3')

    branch_2 = conv3d_bn(img_input, 32, 1, 1, 1, padding='same', name='Conv3d_5b_2a_1x1')
    branch_2 = conv3d_bn(branch_2, 128, 3, 3, 3, padding='same', name='Conv3d_5b_2b_3x3')

    branch_3 = MaxPooling3D((3, 3, 3), strides=(1, 1, 1), padding='same', name='MaxPool2d_5b_3a_3x3')(img_input)
