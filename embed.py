...
for i in range(len(classes)):
        for file in classfiles[i]:
                ...
                np.save('/home/mech/btech/me1130654/scratch/total_compressed_13/flow_threads/'+classes[i]+'/'+file, layer_output)
                ...
                layer_output = get_nth_layer_output([x])[0]
                np.save('/home/mech/btech/me1130654/scratch/total_compressed_13/rgb/'+classes[i]+'/'+file, layer_output)
        print(classes[i])
