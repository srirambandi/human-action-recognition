...
flow_train_path = ["/home/mech/btech/me1130654/scratch/cross_val6/13_total_f_train"+str(i)+".p" for i in range(6)]
rgb_train_path = ["/home/mech/btech/me1130654/scratch/cross_val6/13_total_r_train"+str(i)+".p" for i in range(6)]
label_train_path = ["/home/mech/btech/me1130654/scratch/cross_val6/13_total_l_train"+str(i)+".p" for i in range(6)]
...
for i in range(6):
        ...
        flow_model.save("/home/mech/btech/me1130654/keras-kinetics-i3d/data/cross_val6/13_total_flow_cv"+str(i)+".h5")
