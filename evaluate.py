...
flow_test_path = ["/home/mech/btech/me1130654/scratch/cross_val6/total_f_test"+str(i)+".p" for i in range(6)]
rgb_test_path = ["/home/mech/btech/me1130654/scratch/cross_val6/total_r_test"+str(i)+".p" for i in range(6)]
label_test_path = ["/home/mech/btech/me1130654/scratch/cross_val6/total_l_test"+str(i)+".p" for i in range(6)]
...
for t in range(1):
        rgb_model = Inception_Inflated3d(include_top=False, weights='rgb_imagenet_and_kinetics', input_shape=(None, 7, 7, 832), classes=16)
        rgb_model.load_weights("/home/mech/btech/me1130654/keras-kinetics-i3d/data/cross_val6/total_rgb_cv"+str(t)+".h5")
        flow_model = Inception_Inflated3d(include_top=False, weights='flow_imagenet_and_kinetics', input_shape=(None, 7, 7, 832), classes=16)
        flow_model.load_weights("/home/mech/btech/me1130654/keras-kinetics-i3d/data/cross_val6/total_flow_cv"+str(t)+".h5")
        count = 0
