...
rgb_model.fit_generator(generate_arrays_from_file(rgb_train_path, label_train_path), steps_per_epoch=1009, epochs=600)


rgb_model.save('/home/mech/btech/me1130654/keras-kinetics-i3d/models/rgb1.h5')
