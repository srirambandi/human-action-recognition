...
from gen_data import Inception_Inflated3d
...
SAMPLE_DATA_PATH = {
    'rgb' : '/home/mech/btech/me1130654/keras-kinetics-i3d/data/new_rgb.npy',
    'flow' : '/home/mech/btech/me1130654/keras-kinetics-i3d/data/new_flow.npy'
}

LABEL_MAP_PATH = '/home/mech/btech/me1130654/keras-kinetics-i3d/data/label_map.txt'
...
def main(args):
    ...
    print(sample_predictions.shape, sample_logits.shape, len(kinetics_classes))
