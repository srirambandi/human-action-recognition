...
flow_model.fit_generator(generate_arrays_from_file(flow_train_path, label_train_path), steps_per_epoch=1009, epochs=300)


flow_model.save('/home/mech/btech/me1130654/keras-kinetics-i3d/models/flow2.h5')
